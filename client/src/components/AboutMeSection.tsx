    ...
    <section className="py-16 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          >
            <Card className="bg-gray-900/50 backdrop-blur-md border-purple-600/20 overflow-hidden">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-400">@Ghostyy_r1</span>
                    </div>
                  ...
                  <div className="bg-gray-800/50 rounded-lg p-3">
                    <h4 className="text-sm font-medium text-gray-300 mb-2">About Me</h4>
                    <p className="text-sm text-gray-400">Automotive Service Technician with a passion for motorcycles and ADHD-powered creativity. Living life one ride at a time. 🏍️</p>
                  </div>
