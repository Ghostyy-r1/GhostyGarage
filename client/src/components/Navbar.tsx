          ...
          <div className="hidden md:flex items-center space-x-2">
            {navLinks.map((link) => (
              <Link key={link.path} href={link.path}>
                <a 
                  className={`px-3 py-2 rounded-md text-sm font-medium flex items-center relative group transition-all duration-200 ${
                    location === link.path 
                      ? "text-white" 
            ...
            <Button 
              size="sm" 
              className="ml-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white"
            >
              Sign In
            </Button>
          </div>
